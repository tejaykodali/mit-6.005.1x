...
public class FilterTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "random123", "hey twitterati whats up", d3);
    ...
    @Test
    public void testWrittenByUnlistedUsername() {
        List<Tweet> writtenBy = Filter.writtenBy(Arrays.asList(tweet1, tweet2), "random345");
    ...
    @Test
    public void testInTimespanNoTweetsIncluded() {
        Instant testStart = Instant.parse("2016-03-17T09:00:00Z");
        Instant testEnd = Instant.parse("2016-03-17T10:00:00Z");
    ...
    @Test
    public void testContainingMultipleWordsMultipleTweets() {
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1, tweet2, tweet3), Arrays.asList("talk", "Hey"));
    ...
    public void testContainingNoTweets() {
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1, tweet2, tweet3), Arrays.asList("hello", "why"));
