...
//        throw new RuntimeException("not implemented");
        ...
        List<Tweet> tweetsWrittenByUsername = new ArrayList<Tweet>();
        
        for (Tweet t : tweets) {
            String author = t.getAuthor();
            if (author.toLowerCase().equals(username)) {
                tweetsWrittenByUsername.add(t);
            }
        }
...
//        throw new RuntimeException("not implemented");
        ...
        for (Tweet t : tweets) {
            ...
            for (String w : words) {
                if (Arrays.asList(textWords).contains(w.toLowerCase()) && !tweetsContainingWords.contains(t)) {
